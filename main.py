...
selected_sub_app_name = st.sidebar.radio('Select a sub-app',
                                         list(sub_app_names.values()))
...
tickers_input = st.sidebar.text_area("Enter comma-separated stock tickers",
